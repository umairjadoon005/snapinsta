...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-gradient-to-r from-[#f58529] via-[#dd2a7b] via-40% to-[#515bd4] backdrop-blur supports-[backdrop-filter]:bg-gradient-to-r supports-[backdrop-filter]:from-[#f58529]/60 supports-[backdrop-filter]:via-[#dd2a7b]/60 supports-[backdrop-filter]:to-[#515bd4]/60 dark:bg-gray-900/80">
      <div className="container mx-auto flex h-16 items-center px-4">
        ...
        <nav className="ml-auto hidden items-center gap-6 md:flex">
          ...
          <a
            ...
            className="text-sm font-medium text-white transition-colors hover:text-teal-500"
          >
            {t("links.howItWorks")}
          </a>
          <a
